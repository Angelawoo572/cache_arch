...
OK_COUNT=0
build "baseline" "_cfg/cfg_baseline.json" && OK_COUNT=$((OK_COUNT+1))
build "dumper"   "_cfg/cfg_dumper.json"   && OK_COUNT=$((OK_COUNT+1))
build "replayer" "_cfg/cfg_replayer.json" && OK_COUNT=$((OK_COUNT+1))
