...
#
# This script assumes `projects/legacy_gru_prefetch/scripts/gru_v9_export_decode_sweep.py` was run after
...
#
# Optional:
#   THRESHOLDS="030 050 070 090" DEGREES="1 2 4" TRACE=602.gcc_s-734B bash projects/legacy_gru_prefetch/scripts/run_gru_v9_decode_sweep.sh
...
for TH in $THRESHOLDS; do
  for DEG in $DEGREES; do
    ...
    if [ ! -f "$PFETCH" ]; then
      ...
      echo "          %run -i projects/legacy_gru_prefetch/scripts/gru_v9_export_decode_sweep.py"
      continue
    fi
