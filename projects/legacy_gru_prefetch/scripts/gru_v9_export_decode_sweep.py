...
Run this INSIDE the already-executed `projects/legacy_gru_prefetch/notebooks/gru_sweep_v9.ipynb` runtime,
after the model has been trained and the V9 arrays exist.

In Colab / IPython, use:

    %run -i projects/legacy_gru_prefetch/scripts/gru_v9_export_decode_sweep.py
...
def main() -> None:
    ...
    print(f"  TRACE=<full trace name> bash projects/legacy_gru_prefetch/scripts/run_gru_v9_decode_sweep.sh")
