...
#   bash projects/legacy_gru_prefetch/scripts/dump_trace.sh 605.mcf_s-994B           # train trace
#   bash projects/legacy_gru_prefetch/scripts/dump_trace.sh 620.omnetpp_s-874B       # test  trace
#
