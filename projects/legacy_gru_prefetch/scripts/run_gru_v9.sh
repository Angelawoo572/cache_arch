...
#
# Usage:
#   TRACE=605.mcf_s-994B bash projects/legacy_gru_prefetch/scripts/run_gru_v9.sh
#
# Optional override:
#   PFETCH=/path/to/prefetch_list.txt TRACE=605.mcf_s-994B bash projects/legacy_gru_prefetch/scripts/run_gru_v9.sh
#
...
# Must match the window used by projects/legacy_gru_prefetch/scripts/dump_trace.sh when the CSVs for
