...
RUN_ID="${RUN_ID:-602_offline_lstm_ampm_variable_delta_free_running_v7_seed7}"
STAGE="${STAGE:-collect}"
FORCE="${FORCE:-0}"
JOBS="${JOBS:-8}"
BUILD="${BUILD:-1}"
