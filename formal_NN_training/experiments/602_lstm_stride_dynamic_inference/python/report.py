...
"""
    ...
    text.append(r"The frozen 4/16-MAC cases remain below matched Stride end to end. The same finite table at zero cost isolates the table capacity choice. The timed MAC4/MAC16 cases have zero state evictions, so their losses cannot be attributed to h/c eviction. The finite zero-cost control records 30 evictions.")
