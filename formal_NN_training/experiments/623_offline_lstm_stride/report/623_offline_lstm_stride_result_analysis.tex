...
\texttt{pc\_keyed\_independent\_rank\_delta\_v20} with default run
\texttt{623\_offline\_lstm\_stride\_independent\_delta\_v20\_seed7}; its replay results
...
Neural history & one exact-PC keyed LSTM over lossless PC/address and causal same-input delta/reuse features; chronological TBPTT carries and detaches state.\\
...
Historical run artifact & \texttt{623\_offline\_lstm\_stride\_variable\_delta\_free\_running\_v9\_seed7}.  ``PASS'' certifies that historical experiment contract; it does not certify v20 or useful neural behavior.\\
\end{tabularx}
\end{infobox}
