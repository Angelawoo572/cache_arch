...
Run artifact & \texttt{623\_offline\_lstm\_stride\_variable\_delta\_free\_running\_v9\_seed7}.  ``PASS'' certifies the experiment contract; it does not certify useful neural behavior.\\
\end{tabularx}
\end{infobox}
...
\midrule
Offline Stride & 0.136 & 1.39\% & 1.69\% & 0.51\% & 23.60\% & 4.506\% & 0.070\% & 95.18\% \\
LSTM h5 & 0.088 & 0.00\% & 0.00\% & 0.00\% & -- & 0.000\% & 0.000\% & -- \\
LSTM h16 & 0.090 & 0.00\% & 0.00\% & 0.00\% & -- & 0.000\% & 0.000\% & -- \\
LSTM h32 & 0.090 & 0.00\% & 0.00\% & 0.00\% & -- & 0.000\% & 0.000\% & -- \\
\bottomrule
\end{tabular}}
\end{center}
...
\midrule
Stride & 0.35340 & 0.35340 & 36.790\% & 36.790\% \\
\bottomrule
\end{tabular}
\end{center}
