...
\texttt{compact\_pc\_keyed\_crn\_event\_sampled\_mixture\_v15} with default run
\texttt{623\_offline\_lstm\_stride\_keyed\_crn\_v15\_seed7}; its replay results
...
Historical run artifact & \texttt{623\_offline\_lstm\_stride\_variable\_delta\_free\_running\_v9\_seed7}.  ``PASS'' certifies that historical experiment contract; it does not certify v15 or useful neural behavior.\\
\end{tabularx}
\end{infobox}
