#!/usr/bin/env python3
"""Fail-closed validation for the strict-input direct 602 SPP track."""
import argparse
import csv
import gzip
import hashlib
...
def main():
    ...
    manifest = {
        ...
        "neural_action_decoder": "learned zero/positive categorical mode, unbounded learned positive count, autoregressive direct signed cache-line delta mixture, and learned fill",
