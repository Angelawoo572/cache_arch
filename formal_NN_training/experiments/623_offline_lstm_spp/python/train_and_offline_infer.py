#!/usr/bin/env python3
"""Threshold-free LSTM direct-action students for source SPP on 623.

The LSTM student consumes the same chronological external callback stream as source
...
from formal_NN_training.common.threshold_free_policy import (
    ADDRESS_BITS, advance_lstm_state, behavior_metrics, build_model, decode,
...
def main():
    ...
    if args.model_family != TRACK_MODEL_FAMILY:
        raise RuntimeError("this directory trains LSTM points only")
