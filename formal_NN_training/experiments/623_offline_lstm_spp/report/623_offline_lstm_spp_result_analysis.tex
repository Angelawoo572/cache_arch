...
Run artifact & \texttt{623\_offline\_lstm\_spp\_variable\_delta\_free\_running\_v11\_seed7}.  ``PASS'' certifies the experiment contract; it does not certify useful neural behavior.\\
\end{tabularx}
\end{infobox}
...
\midrule
Offline SPP & 0.660 & 0.17\% & 0.18\% & 0.30\% & 42.44\% & 0.231\% & 0.135\% & 55.68\% \\
LSTM h12 & 0.000 & -- & -- & 0.00\% & -- & -- & -- & -- \\
LSTM h16 & 0.000 & -- & -- & 0.00\% & -- & -- & -- & -- \\
LSTM h32 & 0.000 & -- & -- & 0.00\% & -- & -- & -- & -- \\
\bottomrule
...
\end{center}
\vspace{-2mm}
\textbf{Interpretation.} Count exact match is 41.95\% only because the model
predicts zero on callbacks where SPP also emits zero.  Target precision,
recall, and F1 are all zero, with 804,094 false-negative actions; therefore
that count statistic is not evidence of useful prefetch learning.
...
\midrule
SPP & 0.35391 & 0.35390 & 36.080\% & 36.081\% \\
\bottomrule
\end{tabular}
\end{center}
