...
4. copy the prepared file to formal_NN_training/results/LSTM/draft/artifacts/full_lstm_cache_actions.csv,
...
def main():
    ...
    actions = args.actions or root / f"formal_NN_training/results/LSTM/draft/artifacts/by_trace/{trace}/full_lstm_cache_actions.csv"
    packed_dir = args.packed_dir or root / f"formal_NN_training/results/LSTM/draft/artifacts/packed/{tag}"
    default_actions = root / "formal_NN_training/results/LSTM/draft/artifacts/full_lstm_cache_actions.csv"
