...
formal_NN_training/LSTM/scripts/README.md                     # script usage
```
...
formal_NN_training/LSTM/scripts/README.md
formal_NN_training/LSTM/scripts/00_restore_colab_uploaded_data.sh
formal_NN_training/LSTM/scripts/01_run_spp_trace_dump.sh
formal_NN_training/LSTM/scripts/02_actions_to_prefetch_list.py
formal_NN_training/LSTM/scripts/03_run_lstm_replay.sh
formal_NN_training/LSTM/scripts/04_eval_lstm_accuracy.py
formal_NN_training/LSTM/scripts/07_prepare_actions_for_replay.py
formal_NN_training/LSTM/scripts/08_scout_candidate_traces.sh
formal_NN_training/LSTM/scripts/09_compare_spp_lstm_accuracy.py
```
...
```bash
python3 formal_NN_training/LSTM/scripts/07_prepare_actions_for_replay.py \
  --trace 619.lbm_s-4268B \
  --copy-default
```
...
bash formal_NN_training/LSTM/scripts/03_run_lstm_replay.sh
```

### Compare SPP vs LSTM replay metrics

```bash
python3 formal_NN_training/LSTM/scripts/09_compare_spp_lstm_accuracy.py \
  --trace 619.lbm_s-4268B \
