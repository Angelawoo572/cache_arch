...
It supports the Pythia-style stats printed as key/value lines, for example:
  Core_0_IPC 0.42
  Core_0_L2C_load_miss 123
  Core_0_L2C_prefetch_issued 456
  Core_0_L2C_prefetch_useful 100
  Core_0_L2C_prefetch_late 20
  Core_0_L2C_pq_merged 30

Main derived metrics:
  accuracy              = useful / issued
  nodup_accuracy         = useful / max(issued - pq_merged, 1)
  timeliness             = useful / (useful + late)
  coverage_vs_no_pref    = useful / no_pref_L2_load_miss for the same trace
