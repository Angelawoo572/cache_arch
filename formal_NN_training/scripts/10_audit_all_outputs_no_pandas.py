...
LOG_DIR = ROOT / "formal_NN_training/results/LSTM/draft/replay_compare/logs"
CAP_LOG_DIR = ROOT / "formal_NN_training/results/LSTM/draft/capacity_sweep/logs"
...
def check_action(trace):
    p = ROOT / f"formal_NN_training/results/LSTM/draft/artifacts/by_trace/{trace}/full_lstm_cache_actions.csv"
    if not p.exists():
        return "MISSING", 0, 0, []
    try:
